...
import bpmn2.tutorial.SampleImageProvider.IconSize;
...
public class SampleCustomTaskFeatureContainer extends CustomShapeFeatureContainer {
	...
	public final static String RISK_ID = "bpmn2.tutorial.technicaldebtitem";
	
	private static final IColorConstant TECHNICALDEBT_ITEM_BACKGROUND = new ColorConstant(
			255, 247, 221);
...
//						int height = 60;
						...
						Rectangle roundedRect = gaService.createRectangle(rectShape);
						...
						Image img = SampleImageProvider.createImage(roundedRect, customTaskDescriptor, 50, 50);
			...
			private void setFillColor(ContainerShape containerShape) {
				...
				if (ta!=null) {
					...
					if (Boolean.TRUE.equals(attributeValue)) {
						...
						ss.setDefaultColors(TECHNICALDEBT_ITEM_BACKGROUND);
					}
